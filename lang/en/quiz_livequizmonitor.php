...
$string['extend:addtime'] = 'Presets';
$string['extend:bulklabel'] = 'Extend time';
$string['extend:confirm'] = 'Confirm — add {$a} min';
$string['extend:custominvalid'] = 'Enter a whole number of minutes, from 1 to {$a}.';
$string['extend:customlabel'] = 'Custom minutes';
...
$string['extend:modalbodybulk'] = 'Add more time for all {$a->count} students currently taking the quiz. Choose a preset below, or enter a custom number of minutes. The quiz close time stays the same.';
$string['extend:modalbodyindividual'] = 'Grant {$a->name} more time to finish their attempt. Choose a preset below, or enter a custom number of minutes. The student will be notified immediately.';
...
$string['filter:groupoverrideflag'] = 'This student belongs to a group with an override';
