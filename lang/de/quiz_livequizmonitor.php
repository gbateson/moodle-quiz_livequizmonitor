...
$string['extend:addtime'] = 'Voreinstellungen';
$string['extend:bulklabel'] = 'Zeit verlängern';
$string['extend:confirm'] = 'Bestätigen — {$a} Min. hinzufügen';
$string['extend:custominvalid'] = 'Geben Sie eine ganze Zahl von Minuten ein, von 1 bis {$a}.';
$string['extend:customlabel'] = 'Benutzerdefinierte Minuten';
$string['extend:errornoinprogress'] = 'Derzeit sind keine Teilnehmenden in Bearbeitung (oder im Leerlauf).';
...
$string['extend:modalbodybulk'] = 'Allen {$a->count} Teilnehmenden, die das Quiz gerade bearbeiten, wird mehr Zeit hinzugefügt. Wählen Sie eine Voreinstellung, oder geben Sie eine benutzerdefinierte Anzahl Minuten ein. Die Quiz-Schließzeit bleibt unverändert.';
$string['extend:modalbodyindividual'] = '{$a->name} erhält mehr Zeit zum Abschluss des Versuchs. Wählen Sie eine Voreinstellung, oder geben Sie eine benutzerdefinierte Anzahl Minuten ein. Die teilnehmende Person wird sofort benachrichtigt.';
...
$string['filter:useroverride'] = 'Nutzeränderung';
$string['filter:useroverrideflag'] = 'Für diesen Studierenden liegt eine Nutzeränderung vor';
$string['filter:usertimeoverrideflag'] = 'Für diesen Studierenden liegt eine zeitbezogene Nutzeränderung vor';
